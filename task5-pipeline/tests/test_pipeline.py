...
def test_fetch_recalls_returns_list(mock_get):
    ...
    mock_response.json.return_value = {"results": [{"NHTSACampaignNumber": "21V123000", "Component": "BRAKES", "Summary": "test", "Consequence": "test", "Remedy": "test", "ReportReceivedDate": "15/06/2021", "ModelYear": "2020"}]}
